...
**Document Handling:** Documents are stored as `.txt` files. Each document is treated as standalone; supporting document relationships are not implemented.
...
**Source Citation:** Answers may mention source documents, but citations are not visually highlighted.
